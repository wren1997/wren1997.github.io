---
layout:     post
title:      编译原理实验二和三：预测分析算法的设计与实现以及算符优先
subtitle:   编译原理
date:       2018-11-27
author:     王政乔
catalog: true
...
['E', 'T', 'F']
['#', '(', ')', '*', '+', 'i']
经过消除左递归： {'E': ['+TA', 'TA'], 'T': ['FB', '*FB'], 'F': ['i', '(E)'], 'A': ['+TA', '$'], 'B': ['*FB', '$']}
['#', '$', '(', ')', '*', '+', 'i']
-------结果--------
--产生式：
{'E': ['+TA', 'TA'], 'T': ['FB', '*FB'], 'F': ['i', '(E)'], 'A': ['+TA', '$'], 'B': ['*FB', '$']}
--终结符：
['#', '$', '(', ')', '*', '+', 'i']
--非终结符：
['E', 'T', 'F', 'A', 'B']
